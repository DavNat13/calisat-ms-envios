...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EnvioDuplicadoException.class)
    public ResponseEntity<Map<String, Object>> envioDuplicado(EnvioDuplicadoException ex) {
        log.warn("Envio duplicado rechazado: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> estadoInvalido(EstadoInvalidoException ex) {
        log.warn("Estado de envio invalido: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> integridad(DataIntegrityViolationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Map.of("mensaje", "El registro viola una restriccion de datos (posible guia duplicada)"));
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Map<String, Object>> generico(Exception ex) {
        log.error("Error no controlado en el microservicio de envios", ex);
